...
if ~isempty(masks)
     for i=1:this.hydroSites.nSites
          ...
          %% I srongly suggest to calculate SM by SM=W0/depth;
               ...
               this.px_SM(timeOfStep,i)=mean(this.SM(masks(:,:,i)));
    ...
    this.px_rain(timeOfStep,:)=NaN;
    this.px_SM(timeOfStep,:)=NaN;
    this.px_excS(timeOfStep,:)=NaN;
    this.px_excI(timeOfStep,:)=NaN;
end
