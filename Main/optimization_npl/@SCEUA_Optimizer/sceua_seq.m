%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [bestx,bestf] = sceua_seq(x0,bl,bu,maxn,kstop,pcento,peps,ngs,iseed,iniflg,functn,functAct,simObj,logFile)
...
icall=0;
for i=1:npt;
    xf(i) = functn(functAct,simObj,x(i,:));
    disp(['trial ', num2str(icall),': ', num2str(1-xf(i))]);
    icall = icall + 1;
end;
f0=xf(1);
...
while icall<maxn & gnrng>peps & criter_change>pcento;
    ...
    for igs = 1: ngs;
        ...
        for loop=1:nspl;
            ...
            [snew,fnew,icall]=cceua_seq(s,sf,bl,bu,icall,maxn,functn,functAct,simObj);
...
%         criter_change=abs(criter(20)-criter(20-kstop+1));
