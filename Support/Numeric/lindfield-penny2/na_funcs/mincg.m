...
% Finds local mi of a multivariable non-linear function in n variables
...
% ftau is the line search function. For example see page XXX
% x is a col vector of n starting values, tol gives required accuracy.
% WARNING. Not guarenteed to work with all functions. For difficult
