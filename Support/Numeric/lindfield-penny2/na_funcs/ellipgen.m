...
%
% (¶2/¶ x2+¶2/¶y2)*z+G(x,y)*z=F(x,y) over a rectangular region.
%
...
% Array a is an (ny+1,nx+1) array of sol'ns, inc the boundary values.
% om has no interpretation in this case.
%
% or the function solves
%
% (¶2/¶ x2+¶2/¶y2)*z+lambda*G(x,y)*z=0 over a rectangular region.
%
