...
% and jf (partial derivatives). For example of these functions, see
% page 112. xv is the solution vector, the it parameter is number of
% iterations taken. WARNING. The method may fail, for example if
% initial estimates are poor.
%
it=0; xv=x;
fr=feval(f,xv);
while norm(fr)>tol
