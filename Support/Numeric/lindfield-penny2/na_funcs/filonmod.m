function int = filonmod(func,itype,k,l,u,n)
% Implements filon's integration.
%
% Example call: int = filon(func,itype,k,l,u,n)
% If itype = 1, integrates cos(kx)*f(x) from l to u using n divisions.
% If itype ~= 1, integrates sin(kx)*f(x) from l to u using n divisions.
